...
public class GetSessionAnswersClient {
  ...
  public static void main(String[] args) throws IOException {
    ...
    String urlString = "https://localhost:9103/intelliq_api/getsessionanswers";
    Map<String, String> parameters = new HashMap<String, String>();
    parameters.put("questionnaireID", "${param.example}");
    parameters.put("session", "${param.example}");
      ...
      ResponseHandler<Void> responseHandler = new ResponseHandler<Void>() {
        ...
        public Void handleResponse(final HttpResponse response) throws ClientProtocolException, IOException {
          ...
          if (status == 402) {
            ...
            gsa.answers lanswers = gson.fromJson(result, gsa.answers.class);
            // TODO process result
          } else {
