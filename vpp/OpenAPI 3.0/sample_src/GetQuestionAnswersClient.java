...
public class GetQuestionAnswersClient {
  ...
  public static void main(String[] args) throws IOException {
    ...
    String urlString = "https://localhost:9103/intelliq_api/getquestionanswers";
    Map<String, String> parameters = new HashMap<String, String>();
    parameters.put("questionnaireID", "${param.example}");
    parameters.put("questionID", "${param.example}");
      ...
      ResponseHandler<Void> responseHandler = new ResponseHandler<Void>() {
        ...
        public Void handleResponse(final HttpResponse response) throws ClientProtocolException, IOException {
          ...
          if (status == 402) {
            ...
            gqa.answers lanswers = gson.fromJson(result, gqa.answers.class);
            // TODO process result
          } else {
